...
public class JSFunction {
	...
	클래스의 객체 생성없이 클래스명으로 즉시 메서드를 호출할 수 있다.
	...
	*/
	...
	/* 서블릿이 먼저 실행되기 때문에 위에 작성된 JspWriter out
	는 사용할 수 없다. 
	*/
	...
	*/
	...
	/* 앞의 2개의 메서드는 JSP에서 out내장객체를 받은 후
	 * Javascript함수를 실행한다. 하지만 서블릿에서는 JSP의
	 * 내장객체를 매개변수로 받을 수 없으므로 out내장객체
	 * 대신 response내장객체를 통해 컨텐츠 타입을 설정한 후 
	 * JS코드를 실행해야 한다.*/
