...
choose 태그
 ...
 -->
	...
	<!-- choose태그와 when태그 사이에 HTML주석을 기술하면
	에러가 발생한다. 또한 when 태그와 otherwise사이에도 기술하면
	안된다. -->
	<c:choose>
	...
	<!-- form태그에 속성이 없으면 get방식으로 현재페이지로
	폼값이 전송된다. -->
	<form>
