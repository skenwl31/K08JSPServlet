...
/*
	page영역을 포함한 4가지 영역에는 모든 데이터(객체)를 저장할
	수 있다. Object를 기반으로 저장되므로 차후 값을 읽을 때는
	해당 타입으로 형변환해야한다.
*/
%>
...
<body>
	...
	<ul>
		<!-- Java의 기본 클래스인 경우 별도의 처리없이 즉시 내용을
		출력할 수 있다. -->
	...
	현재 문서에 포함시킨 후 컴파일을 진행한다. 따라서 동일한
	...
	page영역은 공유되지 않는다. 즉, 아래의 링크를 통해 이동한 페이지
