...
<body>
	<h3>변수 선언 및 할당</h3>
	<!-- EL 및 JSTL은 영역에 저장된 속성들을 이용해서 연산하거나 
	출력한다. 따라서 스크립틀릿에서 선언한 변수는 EL에서 사용할 수 없다.
	-->
	<!-- num1은 아무값도 출력되지 않는다. -->
	스크립틀릿에서 선언한 변수 : ${ num1 }<br>
	page 영역에 저장된 변수  : ${ num2 }<br>
	<!-- 톰캣8.0부터는 EL에서 변수할당을 할 수 있다.
	하지만 변수할당과 동시에 출력되므로, 할당문 뒤에 ;''를
	붙여줘야 출력되지 않는다. 즉, EL에서 변수할당은 많이
	사용되지 않는다.-->
	...
	num1 - num2 : ${ num1 - num2 }<br>
	num1 * num2 : ${ num1 * num2 }<br>
	<!-- 나눗셈에는 /와 div연산자를 사용할 수 있다. 또한
	자동형변환이 적용되므로 정수끼리의 연산에서 실수의 결과가
	나올 수 있다. -->
	...
	<!-- 
		...
		&& : And
		|| : Or
	Java에서 사용하던 기본적인 비교 연산자와 문자형태의
	연산자 두가지 모두 사용할 수 있다.	
	 -->
	<h3>비교 연산자</h3>
