...
<body>
	...
	<!-- 포워드 된 페이지에서는 page영역이 소멸되므로,request
	영역이 가장 좁은 영역이 된다. 즉 아래는 request영역의
	속성값이 출력된다. -->
	<h3>영역 지정 없이 속성 읽기</h3>
	<ul>
		<li>${ scopeValue }</li>
	</ul>
	<!-- 앞의 Main파일을 한번 실행하면 4가지 영역 전체에 속성값을
	저장하므로 session, application영역에도 저장된다. 이 값들은 브라우저를
	종료하거나 혹은 서버를 종료해야 소멸되는 영역이므로
